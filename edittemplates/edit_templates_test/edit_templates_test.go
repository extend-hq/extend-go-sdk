...
func TestEditTemplatesRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EditTemplates.Retrieve(
		context.TODO(),
		"edit_template_id_here",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEditTemplatesRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEditTemplatesRetrieveWithWireMock", "GET", "/edit_templates/edit_template_id_here", nil, 1)
}
