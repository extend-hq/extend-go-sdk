...
func TestEditSchemasGenerateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EditSchemas.Generate(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEditSchemasGenerateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEditSchemasGenerateWithWireMock", "POST", "/edit_schemas/generate", nil, 1)
}
