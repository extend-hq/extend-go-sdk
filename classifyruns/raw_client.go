...
func (r *RawClient) List(
...
) (*core.Response[*extend.ClassifyRunsListResponse], error) {
	...
	endpointURL := baseURL + "/classify_runs"
	...
	var response *extend.ClassifyRunsListResponse
	...
	return &core.Response[*extend.ClassifyRunsListResponse]{
...
func (r *RawClient) Delete(
	...
	opts ...option.RequestOption,
) (*core.Response[*extend.ClassifyRunsDeleteResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *extend.ClassifyRunsDeleteResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*extend.ClassifyRunsDeleteResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) Cancel(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/classify_runs/%v/cancel",
		id,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) CreateBatch(
	...
	endpointURL := baseURL + "/classify_runs/batch"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
